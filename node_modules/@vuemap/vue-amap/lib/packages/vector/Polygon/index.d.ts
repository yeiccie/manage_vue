...
export declare const ElAmapPolygon: {
    new (...args: any[]): import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        ...
        $amapComponent: AMap.Polygon;
        destroying: boolean;
        $$getInstance: () => AMap.Polygon;
        parentInstance: import("../../..").IProvideType | undefined;
        resetEditor: import("lodash").DebouncedFunc<() => void>;
        bindModelEvents: () => void;
        emitModel: (target: AMap.Polygon) => void;
        editor: AMap.PolygonEditor;
        attrs: {
            [x: string]: unknown;
        };
...
export declare type ElAmapPolygonInstance = InstanceType<typeof Polygon>;
